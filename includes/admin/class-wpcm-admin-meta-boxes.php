...
class WPCM_Admin_Meta_Boxes {
	...
	public function add_meta_boxes() {
		...
		add_meta_box( 'wpclubmanager-club-info', __( 'Club Information', 'wp-club-manager'), function( $post ){ 
			wp_editor( $post->post_content, 'post_content', array('name'=>'post_content', 'textarea_rows' => 10, 'tinymce' => array( 'resize' => false ) ) );
		...
		if( get_option( 'wpcm_match_show_report', 'yes' ) == 'yes' ) {
			...
			wp_editor( $post->post_content, 'post_content', array('name'=>'post_content', 'textarea_rows' => 20 ) );
