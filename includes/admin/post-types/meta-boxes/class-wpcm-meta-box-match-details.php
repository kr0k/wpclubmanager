...
class WPCM_Meta_Box_Match_Details {
	...
	public static function output( $post ) {
		...
		wpclubmanager_wp_text_input( array( 'id' => 'wpcm_match_date', 'label' => __( 'Date', 'wp-club-manager' ), 'placeholder' => _x( 'YYYY-MM-DD', 'placeholder', 'wp-club-manager' ), 'value' => $date, 'description' => '', 'class' => 'date-picker', 'custom_attributes' => array( 'pattern' => "[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" ) ) );
		
		wpclubmanager_wp_text_input( array( 'id' => 'wpcm_match_kickoff', 'label' => __( 'Time', 'wp-club-manager' ), 'value' => $time, 'class' => 'time-picker' ) ); ?>
